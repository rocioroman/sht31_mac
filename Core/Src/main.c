...
int main(void)
{
  ...
  else
  {
    ...
    while (1)
      ; // Stay here in case of ID failure
  }
  ...
  while (1)
  {
    ...
    // Read temperature and humidity (blocking)
    SHT31_Status status_read = SHT31_ReadTempHum_Blocking(&sensor, &temperature, &humidity);
    ...
    HAL_Delay(2000); // Delay between readings
  }
  /* USER CODE END 3 */
}
